  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-[#080d1a]">
      ...
      <div className="relative flex h-full gap-[5vw] px-[8vw] py-[6vh] items-stretch">
        ...
        <div className="flex-1 flex flex-col gap-[2vw] content-center justify-center">
          <div className="bg-[#0c1522] border rounded-[1.3vw] p-[2vw] flex flex-col gap-[1.2vh]" style={{ borderColor: "rgba(59,130,246,0.25)" }}>
            ...
            <p className="text-[1.05vw] text-[#6b7a8d] font-body leading-snug">Semantic analysis across 10 tabs: Plain English summary, What's Missing, Action Checklist, Required Documents, Deadlines & Risks, Key Terms, Costs, FAQs, Guided Review, Legal Glossary.</p>
          ...
          <div className="bg-[#0c1522] border rounded-[1.3vw] p-[2vw] flex flex-col gap-[1.2vh]" style={{ borderColor: "rgba(245,158,11,0.25)" }}>
            <div className="flex items-center gap-[0.8vw]">
