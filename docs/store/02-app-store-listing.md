...
### iPhone (6.7" — iPhone 15 Plus / 14 Plus) — REQUIRED if 6.9" not provided
- Size: 1290 × 2796 px
...
Enroll before launch to reduce Apple's commission from 30% → 15%:
https://developer.apple.com/app-store/small-business-program/enroll/
(Nearly all indie developers qualify.)
