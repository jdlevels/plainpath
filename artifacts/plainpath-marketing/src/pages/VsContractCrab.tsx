      ...
      <div className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 py-12 sm:py-20">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            ContractCrab is a contract-only review tool at $30/month. PlainPath is a 7-tool document suite for everyday people — leases, medical bills, IRS letters, contracts, and more — starting at $4.99/month.
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-10">
          {[
            ...
            { label: "PlainPath Pro", price: "$19.99/mo", highlight: false, note: "Unlimited + all 7 tools" },
