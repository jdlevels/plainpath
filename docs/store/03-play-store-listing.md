# PlainPath — Google Play Store Listing
...
Read, review, and protect any document in plain English
...
## Content Rating
**Everyone** — ESRB / PEGI equivalent. No violence, no user-generated social content, no objectionable material.

---

## Data Safety (Play Store Data Safety Section)

| Data Type | Collected? | Shared? | Purpose |
|---|---|---|---|
| Email address | Yes (account) | No | App functionality, account management |
| Document text | Yes (processing) | No | Core app feature — AI analysis |
| Usage analytics | Yes | No | Analytics (optional) |
| Payment info | No (handled by Play Billing) | — | — |

**Data encrypted in transit:** Yes
**Users can request data deletion:** Yes — contact support@plainpathapp.com
...
### Phone — REQUIRED
- Size: 1080 × 1920 px (or higher, 16:9 ratio)
...
## Screenshot Content Plan (6 shots — same as App Store)
...
## Feature Graphic
- Size: 1024 × 500 px (required)
- See: `03-store-assets.md` for full spec and design brief
...
| Field | URL |
|---|---|
| Privacy Policy | https://plainpathapp.com/privacy |
| Terms of Service | https://plainpathapp.com/terms |
| Support | https://plainpathapp.com/support |
| Website | https://plainpathapp.com |
