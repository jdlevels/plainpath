...
const TESTIMONIALS = [
  ...
  {
    quote: "I received a 14-page government grant application with requirements buried across three attachments. PlainPath surfaced every required document, deadline, and checkbox — I submitted with three days to spare.",
    name: "Tyler M.",
  ...
  {
    quote: "A new client sent me a consulting agreement with a clause that would have signed away all my background IP. Contract Review caught it in seconds and gave me exact language to push back with.",
    name: "Isabelle C.",
