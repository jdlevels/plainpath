...
const CONFIGS: Record<ScanMode, ScanConfig> = {
  ...
  "contract-review": {
    ...
    findings: [
      ...
      { text: "IP clause — Needs attention", type: "danger", step: 2 },
      { text: "Termination — Review carefully", type: "warning", step: 2 },
    ...
    regions: [
      ...
      { top: 39, height: 11, color: "bg-red-100/70 dark:bg-red-900/25",         chipText: "Needs attention",     chipType: "danger",   step: 2 },
      { top: 57, height: 8,  color: "bg-amber-100/65 dark:bg-amber-900/20",     chipText: "Review carefully",   chipType: "warning",  step: 2 },
      { top: 72, height: 9,  color: "bg-amber-100/50 dark:bg-amber-900/15",     chipText: "Review carefully",   chipType: "warning",  step: 3 },
    ],
    docLines: 20,
