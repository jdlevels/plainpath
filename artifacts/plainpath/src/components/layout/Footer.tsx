...
export function Footer() {
  ...
  return (
    <footer className="bg-white border-t border-border/50 mt-auto no-print safe-bottom">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground/60 max-w-xs leading-relaxed">
              Questions or feedback? <a href="mailto:Test123@gmail.com" className="text-muted-foreground/80 font-medium hover:text-foreground transition-colors">Test123@gmail.com</a>
            </p>
          </div>
