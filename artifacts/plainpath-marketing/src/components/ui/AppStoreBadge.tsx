...
export function AppStoreBadge({ className = '' }: { className?: string }) {
  return (
    <a
      href="#app-store"
      className={`inline-flex items-center gap-3 bg-black text-white rounded-xl px-5 hover:bg-gray-900 transition-colors h-14 min-w-[160px] ${className}`}
    >
      <svg viewBox="0 0 814 1000" className="w-6 h-6 shrink-0 fill-white">
      ...
      <span className="flex flex-col text-left leading-tight">
        <span className="text-[10px] text-gray-300 font-medium tracking-wider uppercase">Download on the</span>
