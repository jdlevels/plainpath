...
### Subtitle *(30 chars max — 32 characters: trim if needed)*
```
Plain English for every document
```

### Description *(4,000 chars max — full text below)*
...
### Short Description *(80 chars max — 54 characters)*
```
...
## 4. SCREENSHOT CAPTIONS (both stores — same copy)
...
Enroll before first submission to reduce Apple's commission from 30% → 15%.
https://developer.apple.com/app-store/small-business-program/enroll/
(Nearly all indie developers qualify — free to enroll.)
