...
const FAQS = [
  ...
  },
  {
    ...
    a: "Analyze a Document and Redact Sensitive Info are available on all plans, including Starter. Document Trust Check, Build a Contract, and Contract Review require a Pro plan. You'll see an upgrade prompt if you try to use them without Pro, and you can switch plans at any time.",
  },
]
