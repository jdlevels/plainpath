      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-20 pb-24">
        ...
        <div className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl font-bold" style={{ fontFamily: "var(--font-display)" }}>Terms of Service</h1>
          </div>
        ...
        <div className="space-y-10">
          ...
          <Section icon={FileText} title="4. Your content">
            ...
            <p>PlainPath does not claim ownership over any content you submit. See our <a href="/privacy" className="text-primary underline underline-offset-2">Privacy Policy</a> for details on how your content is handled.</p>
          </Section>
